...
HD_PWD='C:/Users/Dell/OneDrive/Desktop/m_p_AES/m_p_project_1/m_p_project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aestopmodule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aestopmodule.tcl
